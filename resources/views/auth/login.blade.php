...
>
  <head>
    ...
    <title>Masjid Jami Al-Ma'mur | Admin Area</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                    <img src="{{ asset('images/logo.png') }}" alt="Logos">
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('postLogin') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <div class="invalid-feedback">
                    Anda harus memasukkan username untuk login.
                    </div>
                </div>
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <div class="invalid-feedback">
                        Anda harus memasukkan passwod untuk login.
                    </div>
                  </div>
                </div>
                <div class="mb-3">
